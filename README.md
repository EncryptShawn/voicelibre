...
- It’s basically a hybrid feature-sliced design — features are isolated but we still have shared/ui and lib for cross-cutting stuff
- See the useguide and chatflow in the docs library for more details.
- The structure is fairly clean: no massive files, well-organized, and mostly documented at the top of each doc and with comments at major functions — and in the docs folder.
