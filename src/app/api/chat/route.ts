 ...
 *
 * Exports used by:
 * - src/features/chat/hooks/useStreamingChat.ts (fetches /api/chat for streaming chat)
 * - src/features/bottomBar/hooks/useMemory.ts (fetches /api/chat for memory clear/re-remember)
