...
//
// Exports used by:
// - Invoked by client-side fetches from components such as EditResponderModal (src/features/bottomBar/modals/EditResponderModal.tsx) and chat page (src/app/chat/page.tsx).
//
// Nuances:
