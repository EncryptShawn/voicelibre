// src/features/transcripts/hooks/useTranscripts.ts
//
// Summary:
...
//   src/features/transcripts/ that need transcript data.
//
// Exports:
...
// - src/features/transcripts/TranscriptList.tsx (indirectly via the page).
//
// Nuances:
