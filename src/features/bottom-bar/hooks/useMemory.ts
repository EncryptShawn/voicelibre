// src/features/bottomBar/hooks/useMemory.ts
//
// Summary:
...
//
// Imports to:
// - src/features/chat/hooks/useChat.ts (consumes this hook to provide memory controls in the chat UI)
//
// Exports:
...
//   (batching, streaming) lives in src/features/bottomBar/helpers/memory.ts (reRemember).
//
"use client";
