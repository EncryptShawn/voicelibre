// src/features/chat/pages/ChatLanding.tsx
// Note: This file was created by moving the existing /app/chat/page.tsx content into a feature page,
// adjusting only import paths to match the new feature-first structure. No functional changes.

"use client";
import { useRef, useEffect, useState } from "react";
import { useRouter } from "next/navigation";
import { useChat } from "~/features/chat";
import { EditResponderModal, MemoryStatusModal } from "~/features/bottom-bar";
import type { Responder } from "~/types/responder";
import { HeaderBar } from "~/shared/ui";
import { BottomBar } from "~/features/bottom-bar";
import { SaveTranscriptModal } from "~/features/transcripts";
import { ChatBubble, MicButton, LoginRequiredView } from "~/features/chat";
import { useSession } from "next-auth/react";

/**
 * ChatLanding
 *
 * Primary page UI for the Chat feature.
 * This is the previous content of src/app/chat/page.tsx, moved into the feature.
 */
