/*
  src/features/chat/helpers/usage.ts
  ...
  Exports used by:
    - src/features/chat/components/ChatBubble.tsx (renders usage UI)
    - src/features/chat/hooks/useStreamingChat.ts (maps streaming usage)
    - src/features/chat/hooks/useTTSPlayer.ts (merges TTS audio usage into messages)
